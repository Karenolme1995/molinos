...
// Constructor
  ...
  factory EmpleadoMolinos.fromJson(Map<String, dynamic> json) {
    final rolCompletoValue = _asBool(json['rol_completo'] ?? json['rolCompleto']);
    final rolEstadoValue = _asNullableString(json['rol_estado'] ?? json['rolEstado']) ??
    ...
    return EmpleadoMolinos(
      ...
      numeroNomina: (json['numero_nomina'] ?? json['nomina'] ?? json['numeroNomina'] ?? '').toString(),
      ...
      fechaNacimiento: _asNullableString(json['fecha_nacimiento'] ?? json['fechaNacimiento']),
      ...
      turnoHoraInicio: _asNullableString(json['turno_hora_inicio'] ?? json['turnoHoraInicio']),
      turnoHoraFin: _asNullableString(json['turno_hora_fin'] ?? json['turnoHoraFin']),
      ...
      proximoTurnoId: _asNullableInt(json['proximo_turno_id'] ?? json['proximoTurnoId']),
      ...
      proximoTurnoHoraInicio: _asNullableString(
        json['proximo_turno_hora_inicio'] ??
            json['proximoTurnoHoraInicio'],
      ),
      proximoTurnoHoraFin: _asNullableString(
        json['proximo_turno_hora_fin'] ??
            json['proximoTurnoHoraFin'],
      ),
      proximoTurnoFechaInicio: _asNullableString(
        json['proximo_turno_fecha_inicio'] ??
            json['proximoTurnoFechaInicio'],
      ),
      proximoTurnoFechaFin: _asNullableString(
        json['proximo_turno_fecha_fin'] ??
            json['proximoTurnoFechaFin'],
      ),
      ...
      turnoEnHorario: _asBool(json['turno_en_horario'] ?? json['turnoEnHorario'], defaultValue: true),
      turnoPorConcluir: _asBool(json['turno_por_concluir'] ?? json['turnoPorConcluir']),
      turnosVisibles: _asStringList(json['turnos_visibles'] ?? json['turnosVisibles']),

      acotacion: _asNullableString(json['acotacion']),
      acotacionDescripcion: _asNullableString(json['acotacion_descripcion'] ?? json['acotacionDescripcion']),
      acotacionColor: _asNullableString(json['acotacion_color'] ?? json['acotacionColor']),

      maquinaId: _asNullableInt(json['maquina_id'] ?? json['maquinaId']),
      maquinaNombre: _asNullableString(json['maquina_nombre'] ?? json['maquinaNombre']),

      presente: _asBool(json['presente']),
      checoSalida: _asBool(json['checo_salida'] ?? json['checoSalida']),
      horaEntrada: _asNullableString(json['hora_entrada'] ?? json['horaEntrada']),
      horaSalidaComida: _asNullableString(json['hora_salida_comida'] ?? json['horaSalidaComida']),
      horaRegresoComida: _asNullableString(json['hora_regreso_comida'] ?? json['horaRegresoComida']),
      horaSalida: _asNullableString(json['hora_salida'] ?? json['horaSalida']),
      horaInicioMaquina: _asNullableString(json['hora_inicio_maquina'] ?? json['horaInicioMaquina']),
      horaFinMaquina: _asNullableString(json['hora_fin_maquina'] ?? json['horaFinMaquina']),
      ...
      semanaActual: _asNullableInt(json['semana_actual'] ?? json['semana_anio'] ?? json['semanaActual']),
      semanaActualFechaInicio: _asNullableString(json['semana_actual_fecha_inicio'] ?? json['semanaActualFechaInicio']),
      semanaActualFechaFin: _asNullableString(json['semana_actual_fecha_fin'] ?? json['semanaActualFechaFin']),
      rolFechaInicio: _asNullableString(json['rol_fecha_inicio'] ?? json['rolFechaInicio']),
      rolFechaFin: _asNullableString(json['rol_fecha_fin'] ?? json['rolFechaFin']),
    );
  }
  ...
  String get rangoTurnoActual {
    if ((turnoFechaInicio ?? '').trim().isEmpty && (turnoFechaFin ?? '').trim().isEmpty) {
      return '';
    }
  ...
  String get rangoProximoTurno {
    if ((proximoTurnoFechaInicio ?? '').trim().isEmpty && (proximoTurnoFechaFin ?? '').trim().isEmpty) {
      return '';
    }
  ...
  String get resumenRolConConteo {
    final esperadas = semanasRolRequeridas > 0 ? semanasRolRequeridas : rolSemanasEsperadas;
    final capturadas = semanasRolCapturadas > 0 ? semanasRolCapturadas : rolSemanasCubiertas;
